...
X2022TeamDefenseSorted <-cbind(X2022TeamDefenseSorted, TotFantasyPoints = X2022PassingDefense[,27])
X2022TeamDefenseSorted <- as.data.frame(X2022TeamDefenseSorted)
...
allVars <- lm(X2022TeamDefenseSorted$TotFantasyPoints ~ ., data = X2022TeamDefenseSorted)
